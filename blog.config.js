...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '1edf1dc80d9b480ebdca39c06dc815bb',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个设计师,Hi，我是一个干饭人,欢迎来到我的博客🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yaney.top/', // 网站地址
  ...
  COMMENT_GISCUS_CATEGORY_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOK_zkEs4CcIeZ', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
